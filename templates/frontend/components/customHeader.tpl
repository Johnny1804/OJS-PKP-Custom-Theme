	...
	<div class="pkp_structure_page">
			...
			<div class="pkp_head_wrapper">
				...
				<div class="pkp_site_name_wrapper">
					...
					{if $displayPageHeaderLogo && is_array($displayPageHeaderLogo)}
						...
						<div class="title">
							<a href="{$homeUrl}" class="custom_heading">{$customHeading}</a>
		...
		<div class="custom-sidebar">
		    <div class="sidebar-content">
			    <a>Left Sidebar Content</a>
			</div>
		    <div class="pkp_structure_sidebar left hide" role="complementary" aria-label="Sidebar">
			    <!-- Sidebar elements -->
				{if $leftSidebar}
